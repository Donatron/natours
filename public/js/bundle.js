...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZG9uYXRyb24yMSIsImEiOiJjazQ5MGlheW0wMDJjM2ttb3p4dGV1b2Q5In0.LzMmFUHrmwQdFmOGhrkXEA';
  ...
  locations.forEach(function (location) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(location.coordinates).setHTML("<p>Day ".concat(location.day, ": ").concat(location.description, "</p>")).addTo(map); // Extend map bounds to include the current location
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return regeneratorRuntime.awrap(_axios.default.get('http://localhost:8000/api/v1/users/logout'));
...
var stripe = Stripe('pk_test_QqCBpwZrOuiiC9jBSfRwKoD600l5GeZXXv');
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return regeneratorRuntime.awrap((0, _axios.default)("http://localhost:8000/api/vi/bookings/checkout-session/".concat(tourId)));
...
if (loginForm) {
  console.log('We are go for login form');
